...
parser.add_argument("--model_root", type=str, default="../ILID/scr/model/", help="path to model")
parser.add_argument("--save_dir", type=str, default="../ILID/scr/results", help="path to model")
